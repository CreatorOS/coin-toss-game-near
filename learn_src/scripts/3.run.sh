...
near call $CONTRACT getPlayer1Details '{"gameId":3249096330}' --account_id $OWNER 

#Step 2: Get the gameState after game creation - should be 0

near call $CONTRACT getGameState '{"gameId":3249096330}' --account_id $OWNER
...
near call $CONTRACT joinGame '{"gameId":3249096330}' --amount 10 --account_id gyanlakshmi.testnet
...
near call $CONTRACT chooseGuesser '{"gameId":3249096330}' --account_id $OWNER
